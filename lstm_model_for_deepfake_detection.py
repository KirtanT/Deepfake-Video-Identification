# -*- coding: utf-8 -*-
"""LSTM Model for Deepfake Detection.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YaTzbu322CWQd6Ww6nwkH7jLoLd-R1ks

Model Training

# Important links

Data Collection Document: https://docs.google.com/document/d/1qRPxxtBCu0Q_yTk_RUfcY7HYlDtGVjdUN_ArUtmBS1c/edit?usp=sharing

Prediction Widget: https://colab.research.google.com/drive/1u5S-3ezzPQVKO3ISqNmttz5mF88xke8E?usp=sharing
...
trace the program, keep an eye on the program execution, verify the correctness of each line
...
ipython (interactive python) package, widget for video player

negative accuracy = true negative/total negative

positive accuracy = true positive/total positive
"""