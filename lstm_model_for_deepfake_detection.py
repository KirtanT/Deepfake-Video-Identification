...
#https://drive.google.com/drive/folders/1VIIWRLs6VBXRYKODgeOU7i6votLPPxT0?usp=sharing
url = '1VIIWRLs6VBXRYKODgeOU7i6votLPPxT0'
...
#sequence length is how many frames are processed for training
#print(train_data)
...
class Model(nn.Module):
    def __init__(self, num_classes,latent_dim= 2048, lstm_layers=1 , hidden_dim = 2048, bidirectional = False):
        ...
        #self.norm = nn.LayerNorm(nn.Size([normalized_shape]), eps=1e-05, elementwise_affine=True, device=None, dtype=None)
    def forward(self, x):
